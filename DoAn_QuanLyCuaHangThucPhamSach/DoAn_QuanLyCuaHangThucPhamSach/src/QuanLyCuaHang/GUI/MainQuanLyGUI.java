...
import QuanLyCuaHang.BUS.PhanQuyenBUS;
...
public class MainQuanLyGUI extends JFrame {
    ...
    public MainQuanLyGUI() {
        this.setTitle("Cửa hàng thực phẩm sạch");
    ...
    private void addControls() {
        ...
        pnTitle.setPreferredSize(new Dimension(width,45));
        // ma màu xanh lá cây
        pnTitle.setBackground(new Color(0,255, 0));

        btnDoiMatKhau = new JLabel(new ImageIcon("src/Resource/ManagerUI/setting.png"));
        ...
        /*
        JTextField lblTextField = new JTextField("Quản lý cửa hàng thực phẩm sạch",20);
        lblTextField.setBounds(width / 2 - 428 / 2, 3, 428, 38);
        pnTitle.add(lblTextField);*/
        /*
        JLabel lblTitleText = new JLabel(new ImageIcon("src/Resource/ManagerUI/title-text.png"));
        lblTitleText.setBounds(width / 2 - 428 / 2, 3, 428, 38);
        pnTitle.add(lblTitleText);
        */

        btnMinimize = new JLabel(new ImageIcon("src/Resource/ManagerUI/btn-minimize.png"));
        btnMinimize.setBounds(width - 85, 5, 38, 35);
        btnMinimize.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        pnTitle.add(btnMinimize);

        btnClose = new JLabel(new ImageIcon("src/Resource/ManagerUI/btn-close.png"));
        ...
        JLabel lblAvatar = new JLabel(new ImageIcon("src/Resource/ManagerUI/avatar.png"), JLabel.CENTER);
        lblAvatar.setPreferredSize(new Dimension(250, 210));
        pnMenuLeft.add(lblAvatar);

        lblBanHang = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblBanHang.png"));
        lblKhuyenMai = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblKhuyenMai.png"));
        lblNhapHang = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblNhapHang.png"));
        lblSanPham = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblSanPham.png"));
        lblNhanVien = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblNhanVien.png"));
        lblKhachHang = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblKhachHang.png"));
        lblThongKe = new JLabel(new ImageIcon("src/Resource/ManagerUI/lblThongKe.png"));
    ...
    private void addEvents() {
        ...
        btnMinimize.addMouseListener(new MouseListener() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btnMinimize.setIcon(new ImageIcon("src/Resource/ManagerUI/btn-minimize--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnMinimize.setIcon(new ImageIcon("src/Resource/ManagerUI/btn-minimize.png"));
            }
        });
        ...
        btnClose.addMouseListener(new MouseListener() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btnClose.setIcon(new ImageIcon("src/Resource/ManagerUI/btn-close--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnClose.setIcon(new ImageIcon("src/Resource/ManagerUI/btn-close.png"));
            }
        });
