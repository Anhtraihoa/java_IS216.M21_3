...
import QuanLyCuaHang.DTO.LoaiSP;
import QuanLyCuaHang.DTO.HoaDon;
import QuanLyCuaHang.DTO.SanPham;
import QuanLyCuaHang.DTO.CTHoaDon;
import QuanLyCuaHang.DTO.NhanVien;
import QuanLyCuaHang.BUS.LoaiBUS;
...
import CuaHang.MyTable;
import CuaHang.TransparentPanel;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    final ImageIcon tabbedSelected = new ImageIcon("src/Resource/ManagerUI/tabbed-btn--selected.png");
    final ImageIcon tabbedDefault = new ImageIcon("src/Resource/ManagerUI/tabbed-btn.png");
    ...
    private void addControlsBanHang() {
        ...
        JLabel lblTitleBanHang = new JLabel("Sản phẩm");
        lblTitleBanHang.setFont(new Font("Arial", Font.BOLD, 28));
        btnReset = new JButton(new ImageIcon("src/Resource/Refresh-icon.png"));
        ...
        btnResetHoaDon = new JButton(new ImageIcon("src/Resource/Refresh-icon.png"));
        ...
        btnResetCTHoaDon = new JButton(new ImageIcon("src/Resource/Refresh-icon.png"));
    ...
    private ImageIcon getAnhSP(String src) {
        ...
        File fileImg = new File("src/Resource/SanPham/" + src);

        if (!fileImg.exists()) {
            src = "default.png";
            fileImg = new File("src/Resource/SanPham/" + src);
        }

        try {
            img = ImageIO.read(fileImg);
            fileAnhSP = new File("src/Resource/SanPham/" + src);
        } catch (IOException e) {
            fileAnhSP = new File("src/Resource/SanPham/default.png");
        }
